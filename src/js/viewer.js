const PAGES = [
  {
    ...
    items: [
      ...
      { id: '01f2', name: '검색 필터 (모바일)', file: 'map-mo-filter.html', ready: true, width: 360, label: 'MO' },
      ...
      { id: '01m', name: '기본 화면 (모바일)', file: 'map-mo.html', ready: true, width: 360, label: 'MO' },
      { id: '01m4', name: '모바일 메뉴', file: 'map-mo-menu.html', ready: true, width: 360, label: 'MO' },
      { id: '01m5', name: '모바일 레이어 리스트', file: 'map-mo-lyr.html', ready: true, width: 360, label: 'MO' },
      { id: '01m2', name: '아코디언 목록', file: 'map-mo-peek.html', ready: true, width: 360, label: 'MO' },
      { id: '01m3', name: '아코디언 확장', file: 'map-mo-open.html', ready: true, width: 360, label: 'MO' },
